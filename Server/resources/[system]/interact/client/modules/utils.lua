...
function utils.hasExport(export)
    ...
    return success and handler ~= nil
end
...
SetTimeout(0, function()
    ...
    elseif GetResourceState('vrp'):find('start') then
        require 'client.framework.vrp'
    elseif GetResourceState('es_extended'):find('start') and utils.hasExport('es_extended.getSharedObject') then
