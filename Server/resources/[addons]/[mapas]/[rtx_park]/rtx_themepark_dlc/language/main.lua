Language = {
    ["English"] = {
		...
		["alreadyinattraction"] = "You already have an active ride!",
	...
	["Portuguese"] = {
		...
		["pressforuseseatinteractclassic"] = "Pressione ~INPUT_CONTEXT~ para usar o assento",
		["bindgforceseatuse"] = "Usar GFORCE",
		["bindtopscanseatuse"] = "Usar Top Scan",
		["bindvortexseatuse"] = "Usar Vortex",
		["binddetonatorseatuse"] = "Usar Detonator",
		["bindboatseatuse"] = "Usar Barco",
		...
		["bumperticketpurchased"] = "Você comprou um ingresso para os carrinhos de bate-bate.",
		["alreadyinattraction"] = "Você já está em uma atração ativa!",
		...
		["pressforbuyticketthemeparkinteract"] = "Pressione <span id='infobindcolor'>"..Config.ThemeParkTicketMachineSettings.usekey.."</span> para comprar ingresso",
		...
		["themeparkfall"] = "Você caiu da atração",		
		["themeparkallowed"] = "Você liberou o acesso às atrações do parque",
		["themeparkblocked"] = "Você bloqueou o acesso às atrações do parque",	
		["bindseatuse"] = "Usar atração",
		["leaveattraciton"] = "Sair da atração",
		["attractioninprogress"] = "A atração já começou",		
		["attractioncamera"] = "Trocar câmera",			
	},   
}