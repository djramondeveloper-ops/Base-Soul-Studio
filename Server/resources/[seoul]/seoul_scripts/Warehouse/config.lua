...
WarehouseConfig.maxPurchases = 6 -- Quantidade maxima que um player pode comprar
...
-- discord logs
WarehouseConfig.Webhook = ''
WarehouseConfig.BotToken = ''

WarehouseConfig.sellpros = 0.25 -- Porcentagem que irá perder ao vender
