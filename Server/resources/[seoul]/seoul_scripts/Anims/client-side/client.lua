if SeoulScriptsClient and not SeoulScriptsClient.Enabled('Anims') then return end
-- 60309 MAO ESQUERDA
-- 28422 MAO DIREITA
-- 50 NÃO REPETE
-- 49 REPETE
...
-----------------------------------------------------------------------------------------------------------------------------------------
-- SEOUL SCRIPTS ANIMS ALIASES
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('seoul_scripts:emote')
AddEventHandler('seoul_scripts:emote', function(name)
    TriggerEvent('emotes', name)
end)

RegisterCommand('seoulemote', function(_, args)
    if args and args[1] then
        TriggerEvent('emotes', args[1])
    else
        TriggerEvent('Notify','aviso','Use /seoulemote nome',5000)
    end
end)

exports('PlayEmote', function(name)
    TriggerEvent('emotes', name)
end)
