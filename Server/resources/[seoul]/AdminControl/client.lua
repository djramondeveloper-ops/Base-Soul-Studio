...
function Client.openMainMenu()
    lib.registerContext({
        ...
        options = {
            ...
            {
                title = 'Prop Editor',
                description = 'Criar e editar props e mapas da cidade',
                icon = "fa-solid fa-cubes",
                onSelect = function ()
                    TriggerServerEvent("AdminControl:openPropEditor")
                end
            },
            {
                title = 'Vinewood',
                description = 'Editar texto e cor do letreiro de Vinewood',
                icon = "fa-solid fa-font",
                onSelect = function ()
                    TriggerServerEvent("AdminControl:openVinewood")
                end
            },
            {
                title = 'Bordéis',
                description = 'Criar e configurar bordéis da cidade',
                icon = "fa-solid fa-building",
                onSelect = function ()
                    TriggerServerEvent("AdminControl:openBrothels")
                end
            },
            {
                title = 'Grupos',
