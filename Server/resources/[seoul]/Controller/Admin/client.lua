...
-- NOCLIP
-----------------------------------------------------------------------------------------------------------------------------------------
SeoulRegisterCommand("nc",function(source,args,rawCommand)
...
RegisterNetEvent("Controller:ToggleDebug")
AddEventHandler("Controller:ToggleDebug",function()
...
function AdminClient.showItemlist()
    ...
    for k,v in pairs(items) do
        options[#options + 1] = { value = k, label = v.label or v.name or k }
    end
