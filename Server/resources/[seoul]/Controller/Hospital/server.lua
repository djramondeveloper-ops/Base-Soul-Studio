if Config.Modules and Config.Modules.Hospital == false then return end
...
SeoulRegisterCommand("sangramento",function(source,args,rawCommand)
...
SeoulRegisterCommand("diagnostico",function(source,args,rawCommand)
	local nplayer = vRPclient.nearestPlayer(source,3)
...
SeoulRegisterCommand("tratamento",function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	local nplayer = vRPclient.nearestPlayer(source,3)
