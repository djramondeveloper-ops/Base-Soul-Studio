Locales['en'] = {
    ...
    COMMANDS_MESSAGES = {
        ...
        RESOURCE_LOADING = 'Script requires running active database, missing oxmysql/mysql-async',
    ...
    LOGS_ACTIONS = {
        ...
        LOG_CITIZEN_CITIZEN_ESCAPED_THIRD_PARTY_PRISON_BREAK = "%s escaped from prison!",
