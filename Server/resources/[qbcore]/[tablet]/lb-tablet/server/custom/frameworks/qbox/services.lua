...
local function GetSocietyMoney(job)
    return exports["ps-banking"]:GetAccountBalance(job) or 0
end
...
RegisterCallback("qbx:services:addMoney", function(source, amount)
    ...
    local success = exports["ps-banking"]:AddMoney(jobName, amount, "Depósito pelo tablet")
...
RegisterCallback("qbx:services:removeMoney", function(source, amount)
    ...
    local success = exports["ps-banking"]:RemoveMoney(jobName, amount, "Saque pelo tablet")
