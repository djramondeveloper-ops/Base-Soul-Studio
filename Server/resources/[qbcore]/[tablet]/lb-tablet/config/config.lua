...
Config.LBPhone = true -- lb-phone está instalado nesta base
...
Config.Item = {}
Config.Item.Require = true -- cadastre lb_tablet na vrp/config/Item.lua conforme o README
Config.Item.Name = "lb_tablet" -- name of the tablet item
...
--[[ ENTITY OPTIONS ]] --
Config.TabletModel = `imp_prop_impexp_tablet` -- the prop of the tablet, if you want to use a custom tablet model, you can change this here
...
Config.Services.Companies = { -- the companies that are shown in the app
    ...
    {
        job = "PRPD",
        name = "Seoul Ranger Department",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
        canMessage = true
    },
    {
        job = "Paramedic",
        name = "Seoul Medical Department",
        icon = "https://cdn-icons-png.flaticon.com/128/1032/1032989.png",
        canMessage = true
    },
    {
...
-- A Origens usa os grupos reais LSPD e PRPD. Ambos compartilham as
-- permissões do aplicativo policial.
Config.Police.Permissions.LSPD = Config.Police.Permissions.police
Config.Police.Permissions.PRPD = Config.Police.Permissions.police
Config.Police.Permissions.police = nil

Config.Police.Header = {
    Logo = "./assets/img/icons/police/logo.png",
    Title = "Seoul Police Department",
    Subtitle = "Seoul Police MDT"
}
...
Config.Ambulance.Header = {
    ...
    Title = "Seoul Medical Department",
    Subtitle = "Seoul Medical MDT"
}
...
Config.Ambulance.Permissions.Paramedic = Config.Ambulance.Permissions.ambulance
Config.Ambulance.Permissions.ambulance = nil
...
-- Integração direta com a vRP desta base
Config.VRP = {
    AdminPermission = "Admin",
    DefaultJob = "unemployed",
    Jobs = {
        LSPD = { label = "Seoul Police Department", bossGrade = 1 },
        PRPD = { label = "Seoul Ranger Department", bossGrade = 1 },
        Paramedic = { label = "Seoul Medical Department", bossGrade = 1 },
        Mechanic = { label = "Mecânica Auto Care", bossGrade = 1 },
