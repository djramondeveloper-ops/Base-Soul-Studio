return {
    Actions = {
        ...
        ["change_weather"] = {
            ...
            dropdown = {
                ...
                { label = "Confirmar", option = "button", type = "server", event = "mri_Qadmin:server:SetSeoulWeather" },
            },
        },
        ...
        ["change_time"] = {
            ...
            dropdown = {
                ...
                { label = "Confirmar", option = "button", type = "server", event = "mri_Qadmin:server:SetSeoulTime" },
            },
        },
        ...
        ["fix_vehicle"] = {
            ...
            type = "client",
            event = "mri_Qadmin:client:SeoulFixVehicle",
        ...
        ["teleport_to_marker"] = {
            ...
            type = "client",
            event = "mri_Qadmin:client:SeoulGotoWaypoint",
    ...
    PlayerActions = {
        ["teleportToPlayer"] = {
            ...
            ["openInventoryPlayer"] = {
                label = "Abrir Inventário",
                event = "mri_Qadmin:server:OpenInv",
                perms = "qadmin.action.open_inventory",
                type = "server"
            },
