...
Config.Fuel = "ox_fuel"        -- Seoul: rcore_fuel fornece a compatibilidade/export de ox_fuel
Config.Dealership = "none"     -- "mri" (for qbx_vehicleshop with stock system) or "none" to disable
...
-- Key Bindings
Config.Keybindings = false -- Seoul: painel aberto pelo Seoul Tablet
Config.AdminKey = "0"
Config.NoclipKey = "9"

-- General
Config.PrintLevel = "none" -- "none" | "error" | "warn" | "info" | "verbose" | "debug"
Config.QBCoreAutoSync = false -- Seoul: acesso real vem do grupo vRP Admin -- Auto-promote players with QBCore 'admin'/'god' to mri_Qadmin 'admin' group
