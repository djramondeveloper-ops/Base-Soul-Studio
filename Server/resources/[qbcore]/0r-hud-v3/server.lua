...
if Config.DefaultHudSettings.client_info
    and Config.DefaultHudSettings.client_info.server_info
    and Config.DefaultHudSettings.client_info.server_info.showOnlinePlayers then
