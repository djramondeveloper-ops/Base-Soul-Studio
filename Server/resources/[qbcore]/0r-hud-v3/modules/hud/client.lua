...
local function getMinimapPositions(mapType, screenResolution)
    ...
    if not mapPlacer then
        ...
        positions.minimap.x = positions.minimap.x + minimapOffset
        positions.minimap_blur.x = positions.minimap_blur.x + minimapOffset
        positions.minimap_mask.x = positions.minimap_mask.x + minimapOffset
...
function Hud.CheckRadarDisplay()
    DisplayRadar(false)
    if client.IsPlayerLoaded and client.IsPlayerLoaded() and client.uiLoad then
