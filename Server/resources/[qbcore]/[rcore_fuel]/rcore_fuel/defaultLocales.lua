...
DefaultLocales = {
    ...
    -- FIX 2: jerrycan_guide was in locales/en.lua but missing from defaultLocales fallback
    ...
    pumping_out = "Pumping out the fuel [\240\159\146\167]",
    ...
    select_car = [[
Awesome! Now, just look at the car you want to refuel until it glows, then press ~INPUT_ATTACK~
Use key ~INPUT_COVER~ to switch the fuel type!]],
    ...
    wrong_price = "The price of the company can be between only $%s and $%s!",
    ...
    processing_oil = "Preparing oil barrel [\240\159\155\162\239\184\143]",
    final_pumping = "Transferring fuel [\240\159\148\139]\239\184\143",
