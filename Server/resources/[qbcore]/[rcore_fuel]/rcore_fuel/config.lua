...
Config.KeyMaps = {
    [KeyAction.GENERATOR] = {
        action = "E",
        label = "recolher gerador do chão",
    },

    [KeyAction.JERRYCAN] = {
        action = "E",
        label = "abastecer veículo próximo usando o galão",
    },

    [KeyAction.SWITCH_FUEL_TYPE] = {
        action = "Q",
        label = "alternar tipo de combustível",
    },

    [KeyAction.CALL_TAXI] = {
        action = "E",
        label = "chamar táxi próximo ao marcador",
    },

    [KeyAction.DROP_BARREL] = {
        action = "X",
        label = "soltar o barril que estiver carregando",
    },

    [KeyAction.PICKUP_NOZZLE] = {
        action = "E",
        label = "pegar o bico de combustível",
    },

    [KeyAction.REFUEL_VEHICLE] = {
        action = "MOUSE_LEFT",
        label = "selecionar veículo para abastecer",
    },
