		...
		if LocalPlayer["state"]["Active"] and Active and Information[Active] then
			if IsPauseMenuActive() then
				...
				for Index,v in pairs(Users) do
					if Information[v.Permission] and Information[v.Permission][v.Level] and ((LocalPlayer["state"]["Paramedic"] and v.Permission == "Paramedic") or (CheckPolice() and v.Permission ~= "Paramedic")) then
				...
				if IsPedInAnyVehicle(Ped) then
					...
					for Index,v in pairs(Players) do
						if List[Index] then
							if not Markers[Index] and Information[v.Permission] and Information[v.Permission][v.Level] and ((LocalPlayer["state"]["Paramedic"] and v.Permission == "Paramedic") or (CheckPolice() and v.Permission ~= "Paramedic")) then
