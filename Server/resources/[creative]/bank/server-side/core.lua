...
-- ADDTAXES
-----------------------------------------------------------------------------------------------------------------------------------------
exports("AddTaxes",function(Passport,Source,Name,Valuation,Description)
	...
	TriggerClientEvent("Notify",Source,"Banco Fleeca","Nova tarifa de <b>"..Currency..""..Dotted(Price).."</b> adicionada.","dollar",5000)
