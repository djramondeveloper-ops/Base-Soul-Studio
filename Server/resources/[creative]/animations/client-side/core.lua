...
local animacoes = {
	...
	["dancar700"] = { dict = "cm@dance4@clip", anim = "dance4_clip", walk = false, loop = true },
	["dancar701"] = { dict = "cm@dance5@clip", anim = "dance5_clip", walk = false, loop = true },
	["dancar702"] = { dict = "cm@dance6@clip", anim = "dance6_clip", walk = false, loop = true },
	...
	["mecanico6"] = { dict = "anim@amb@clubhouse@tutorial@bkr_tut_ig3@", anim = "machinic_loop_mechandplayer", walk = true, loop = true },
	["macarena"] = { dict = "camsurmotion@macarena", anim = "macarena_clip", walk = false, loop = true },
	["gangnamstyle"] = { dict = "camsurmotion@gangnamstyle", anim = "gangnamstyle_clip", walk = false, loop = true },
	["newhiphop"] = { dict = "camsurmotion@hiphop1", anim = "hiphop1_clip", walk = false, loop = true },
	["wavehiphop"] = { dict = "cm@wavehiphop@clip", anim = "wavehiphop_clip", walk = false, loop = true },
	["chickendance"] = { dict = "cm@chickendance@clip", anim = "chickendance_clip", walk = false, loop = true },
	["ymcadance"] = { dict = "cm@ymcadance@clip", anim = "ymca_clip", walk = false, loop = true },
	["salsa"] = { dict = "cm@salsa1@clip", anim = "salsa1_clip", walk = false, loop = true },
	["samba"] = { dict = "cm@samba@clip", anim = "samba_clip", walk = false, loop = true },
	["fundance"] = { dict = "cm@dancefun@clip", anim = "dancefun_clip", walk = false, loop = true }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- ANIMATIONS:EMOTES
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("animations:Emotes")
AddEventHandler("animations:Emotes",function(Name,Item)
	local Ped = PlayerPedId()
	if not IsPedArmed(Ped,7) and not IsPedSwimming(Ped) and GetEntityHealth(Ped) > 100 and not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Buttons"] and not LocalPlayer["state"]["Cancel"] and not LocalPlayer["state"]["Handcuff"] then
		if animacoes[Name] then
			if Name == "chuva" and not Item then
				TriggerEvent("Notify","Atenção","Utilize o item <b>"..ItemName("umbrella").."</b> para realizar esta animação.","amarelo",5000)
				return
			end
			...
			TriggerEvent("Notify","Aviso","A animação <b>"..Name.."</b> não existe.","vermelho",5000)
		end
	end
end)