...
RegisterCommand("inv",function(source,Message)
	...
	Player(OtherSource).state.canSteal = true
	TriggerClientEvent("inspect:Open",source,OtherSource)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- INSPECT:PLAYER
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("inspect:Player",function(OtherSource)
	...
	local IsPolice = vRP.HasGroup(Passport,"Police")
	local IsOtherPolice = vRP.HasService(OtherPassport,"Police")
...
function Creative.Reset()
	...
	if Target then
		if vRP.DoesEntityExist(Target) then
			Player(Target).state.canSteal = false
