...
local WeatherWhitelist = { ["EXTRASUNNY"] = true, ["CLEAR"] = true, ["NEUTRAL"] = true, ["SMOG"] = true, ["FOGGY"] = true, ["OVERCAST"] = true, ["CLOUDS"] = true, ["CLEARING"] = true, ["RAIN"] = true, ["THUNDER"] = true, ["SNOW"] = true, ["BLIZZARD"] = true, ["SNOWLIGHT"] = true, ["XMAS"] = true, ["HALLOWEEN"] = true }
-----------------------------------------------------------------------------------------------------------------------------------------
-- PERMISSIONS
-----------------------------------------------------------------------------------------------------------------------------------------
...
function Creative.Server()
	...
	return {
		Weather = WeathersType(GlobalState.Weather) or "CLEAR",
...
function Creative.SetWeather(Data)
	...
	TriggerClientEvent("Notify",Source,ServerName,WeatherWarning.." <b>"..WeathersType(Weather).."</b>.","weather",10000,"bottom-center")
	return true
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- TICKETS
