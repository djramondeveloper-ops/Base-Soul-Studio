				...
				if v.Route == Route then
					...
					if #(Coords - OtherCoords) <= 50 then
						if not Objects[Index] then
							exports.target:AddBoxZone("Plants:"..Index,vec3(OtherCoords.x,OtherCoords.y,OtherCoords.z + 0.65),0.4,0.4,{
								name = "Plants:"..Index,
								heading = v.Coords[4],
...
-- PLANTS:STARTFIRE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("plants:StartFire")
AddEventHandler("plants:StartFire", function(Coords)
	if not Coords then return end

	StartScriptFire(Coords[1],Coords[2],Coords[3],25,false)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- CREATEMODELS
-----------------------------------------------------------------------------------------------------------------------------------------
