...
AddEventHandler("inventory:Cleaner",function(Ped)
	...
	local HasParachute = HasPedGotWeapon(Ped,ParachuteHash,false)
	...
	if HasParachute then
		...
		SetPedParachuteTintIndex(Ped,math.random(0,8))
	else
		RemoveAllPedWeapons(Ped,true)
	end
...
-----------------------------------------------------------------------------------------------------------------------------------------
-- INVENTORY:STARTVEHICLEALARM
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("inventory:StartVehicleAlarm")
AddEventHandler("inventory:StartVehicleAlarm",function(Network)
...
-----------------------------------------------------------------------------------------------------------------------------------------
local FishingAreas = {
	vec3(2003.91,4230.95,29.93),
	vec3(1038.35,3938.64,31.27),
	vec3(210.77,4032.24,30.72)
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- FISHING
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Fishing()
	...
	for _,Area in ipairs(FishingAreas) do
		if #(Coords - Area) <= 150 then
			return true
		end
	end
...
function Creative.Restaurant()
	...
	return BurgerShot:isPointInside(Coords)
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADLEAVESERVICE
-----------------------------------------------------------------------------------------------------------------------------------------
