...
function Creative.Parachute()
	...
	if HasPedGotWeapon(Ped,ParachuteHash,false) then
	...
	if not HasPedGotWeapon(Ped,ParachuteHash,false) then
		GiveWeaponToPed(Ped,0xFBAB5776,1,false,true)
		Wait(100)
	end
	
	if HasPedGotWeapon(Ped,ParachuteHash,false) then
		SetCurrentPedWeapon(Ped,ParachuteHash,true)
		SetPedParachuteTintIndex(Ped,math.random(0,8))
	elseif HasPedGotWeapon(Ped,0xFBAB5776,false) then
		SetCurrentPedWeapon(Ped,0xFBAB5776,true)
		SetPedParachuteTintIndex(Ped,math.random(0,8))
	end
	
	TriggerEvent("Notify","Sucesso","Paraquedas equipado com sucesso.","verde",5000)
end