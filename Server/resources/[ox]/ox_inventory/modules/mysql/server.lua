...
Citizen.CreateThreadNow(function()
    ...
    if shared.framework == 'vrp' then
        -- vRP/Creative stores character data in playerdata by Name; keep OX player inventories isolated.
        Query.SELECT_PLAYER = 'SELECT data FROM ox_inventory WHERE owner = ? AND name = \'player\''
        Query.UPDATE_PLAYER = 'INSERT INTO ox_inventory (data, owner, name) VALUES (?, ?, \'player\') ON DUPLICATE KEY UPDATE data = VALUES(data)'
    end
