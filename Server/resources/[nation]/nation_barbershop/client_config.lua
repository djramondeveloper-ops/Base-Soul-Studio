...
function drawChairMarkers()
    ...
    for k,v in ipairs(barberChairs[barberId]) do
        ...
        DrawMarker(0,x,y,z+0.5,0,0,0,0,0,0,0.25,0.25,0.25,246, 81, 88,50,1,1,1,1)
    end
end
...
-- RegisterNetEvent("dukeInteractionClear")
-- AddEventHandler("dukeInteractionClear", function()
--     exports["interaction-main"]:closeInteraction()
--     exports["interaction-secondary"]:closeInteraction()
-- end)
...
RegisterNetEvent("nation_barbershop:toggleMenu")
AddEventHandler("nation_barbershop:toggleMenu", function()
