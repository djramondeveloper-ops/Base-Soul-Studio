...
local animMas = {
    {"pfrapmonster@animations", "pfrapmonsterclip"},
    {"pfdeepexplorer@animations","pfdeepexplorerclip"},
    { "pfcalifornialove@animations","pfcalifornialoveclip"},
    { "pflinedancin@animations","pflinedancinclip"},
    { "pfoutlaw@animations", "pfoutlawclip"},
    { "pfwhatyouwant@animations", "pfwhatyouwantclip"},
    { "pfsnoopswalk@animations", "pfsnoopswalkclip"}
}
local animFem = {
    {"pftheviper@animations", "pftheviperclip"},
    {"pfattraction@animations", "pfattractionclip"},
    {"pfskyward@animations", "pfskywardclip"},
    {"pflinedancin@animations","pflinedancinclip"},
    {"pfmine@animations", "pfmineclip"},
    {"pfsoarabove@animations","pfsoaraboveclip"},
    {"pfcaffeinated@animations", "pfcaffeinatedclip"},
}
...
setClothes = function(custom)
    ...
    for k,v in pairs(custom or {}) do
        if type(v) == "table" and v[1] then
            ...
            elseif index >= 0 and index < 12 then
...
local multiCharButtons = {
    selectChar = function(data, cb)
        ...
        freezeAnim("anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity", "hi_dance_facedj_11_v1_female^6", 1, true)
