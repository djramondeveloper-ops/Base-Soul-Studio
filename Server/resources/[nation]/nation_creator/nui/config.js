const imgDir = "nui://nation_creator/nui/nation_creator/"; // DIRETÓRIO DAS IMAGENS
...
const pt_BR = {
    ...
    creatorSubtitle: "Você esta criando um novo personagem",
    identity: "IDENTIDADE",
    name: "NOME",
    lastName: "SOBRENOME",
    age: "IDADE",
    ...
    multiCharSubtitle: "Selecione o seu personagem na cidade ou crie um personagem novo.",
    createChar: "CRIAR",
    empty: "VAZIO",
    charInfo: "INFORMAÇÕES DO PERSONAGEM",
    charInfoSubtitle: "Confira as informações do seu personagem.",
    job: "PROFISSÃO",
    wallet: "CARTEIRA",
    bank: "BANCO",
    registration: "SANGUE",
...
const icons = {
    ...
    rotate: `<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 26 36"
        style="enable-background:new 0 0 26 36" xml:space="preserve">
        <style type="text/css">
            <![CDATA[
            .st0 {
                fill-rule: evenodd;
        ...
        <g>
            <path class="st0"
                d="M13 5.4C20.1789 5.4 26 10.242 26 16.2C26 19.224 24.4978 21.96 22.0856 23.922C23.6311 22.356 24.5556 20.376 24.5556 18.234C24.5556 13.122 19.3844 9 13 9V14.4L7.22222 7.2L13 0V5.4ZM13 30.6C5.82111 30.6 0 25.758 0 19.8C0 16.776 1.50222 14.04 3.91444 12.078C2.36889 13.644 1.44444 15.624 1.44444 17.784C1.44444 22.878 6.61556 27 13 27V21.6L18.7778 28.8L13 36V30.6Z" fill="#E2641A" />
        </g>
    </svg>`,
