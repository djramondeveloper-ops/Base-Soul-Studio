...
function changeWordColor(elementClass) {
    const elements = document.querySelectorAll(elementClass);
    elements.forEach((element) => {
        const words = element.innerText.split(" ");
        if (words.length > 1) {
            const lastWord = words.pop();
            element.innerHTML = `${words.join(" ")} <span class="highlight">${lastWord}</span>`;
        }
    })
}
...
const buildContainer = () =>{
    let camInner = `<div class="cam-wrapper">
    ...
    <div class="top-creator">
         <div class="square">
            <img src="src/icons/creator.svg" alt="Creator Icon" />
        </div>
        <div class="title-creator">${lang.title}</div>
        <div class="subtitle">${lang.creatorSubtitle}</div>
        </div>
    <div class="pages-container">
        <div class="middle-creator page-one">
            <div class="component-title-one">${lang.identity}</div>
            <div class="identity">
            ...
            <div class="component-title-one">${lang.gender}</div>
           ...
           <div class="component-title-one">${lang.heritage}</div>
            <div class="heritage-img">
                <div class="shapeFirst-container">
                    <img class="shapeFirst" src="${imgDir}parents/${player.shapeFirst}.png" alt="">
                    <button class="select-parent" onclick="buildParentSelection('${lang.selectMom}', 'shapeFirst');">
                        ${lang.selectMom}
                    </button>
                </div>
                <div class="shapeSecond-container">
                    <img class="shapeSecond" src="${imgDir}parents/${player.shapeSecond}.png" alt="">
                    <button class="select-parent" onclick="buildParentSelection('${lang.selectDad}', 'shapeSecond');">
                        ${lang.selectDad}
                    </button>
                </div>
            </div>

            <div class="component-title-one">${lang.resemblance}</div>
        ...
        <div class="middle-creator page-two">
            <div class="component-title-creator">${lang.momColor}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.dadColor}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.skinTone}</div>
            <div class="slider-container">
            ...
            <div class="component-title-creator">${lang.bodyBlemishes}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-three">
            <div class="component-title-creator">${lang.eyesColor}</div>
            ...
            <div class="component-title-creator">${lang.eyesOpenning}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.eyebrows}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator eyeBrow">${lang.eyeBrownHigh}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator eyeBrowForwad">${lang.eyeBrownForward}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-four">
            <div class="component-title-creator">${lang.noseWidth}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.nosePeakHeight}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.nosePeakLength}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.nosePeakLowering}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.noseBoneHigh}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.noseBoneTwist}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-five">
            <div class="component-title-creator">${lang.chinBoneLowering}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.chinBoneLength}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.chinBoneWidth}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.chinHole}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.jawBoneWidth}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.jawBoneBackLength}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-six">
            <div class="component-title-creator">${lang.cheeksBoneHigh}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.cheeksBoneWidth}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.cheeksWidth}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.neckThickness}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.lipsThickness}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-seven">
            <div class="component-title-creator">${lang.complexion}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.sunDamage}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.freckles}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.ageing}</div>
            <div class="slider-container">
                <p class="perc"></p>
            ...
            <div class="component-title-creator">${lang.blemishes}</div>
            <div class="slider-container">
                <p class="perc"></p>
        ...
        <div class="middle-creator page-eight">
            <div class="component-title-creator">${lang.hair}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator">${lang.beard}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator">${lang.chestHair}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator">${lang.blush}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator">${lang.lipstick}</div>
            <div class="shape-color-buttons">
            ...
            <div class="component-title-creator">${lang.makeup}</div>
            <div class="shape-color-buttons">
    ...
    <div class="bottom">
        ...
        <div class="rotate">
            ${icons.rotate}
            <span>Use as teclas <span class="highlight">A</span> e <span class="highlight">D</span> para girar o personagem</span>
        </div>
    </div>`;


    let multiCharContainerInner = `
    <div class="top">
    <div class="square">
        <img src="src/icons/address-card.svg" alt="Address Icon" />
    </div>
    <div class="title">${lang.multiCharTitle}</div>
    <div class="subtitle">${lang.multiCharSubtitle}</div>
    </div>
    <div class="middle multichar-scroll"></div>
    `;
    let multiCharContainer2Inner = `
    <div class="top-right">
        <div class="square">
            <img src="src/icons/info.svg" alt="Info Icon" />
        </div>
        <div class="title-right">${lang.charInfo}</div>
        <div class="subtitle">${lang.charInfoSubtitle}</div>
    </div>
    ...
    <div class="component-container delete-char">
        <div class="component-title">
...
`;
    let loginInner = `<div class="login-container">
        <div class="top-login"><div class="title">${lang.selectSpawn}</div></div>
        <div class="middle-login spawn-scroll"></div>
    </div>
    ...
    changeWordColor('.title');
    changeWordColor('.title-right');
    changeWordColor('.title-creator');
    buildCamIcons();
}
...
const selectParent = (key, index, el) => {
    ...
    if (el) $(el).addClass("option-selected").append("<div class='option-checked'></div>");
...
const selectOption = (option, index, el) => {
    $(".option-select").removeClass("option-selected");
    $(".option-checked").remove();
    $(el).addClass("option-selected").append("<div class='option-checked'></div>");
...
const showAllParents = (key) => {
    ...
    for (let i in parents) {
        ...
        if (i == player[key]) {
            ...
            icon = "<div class='option-checked'></div>";
        }
        div += `
        <div class="${classe}" onclick="selectParent('${key}', ${i}, this)">
            <div class="parent-container">
                <img src="${imgDir}parents/${i}.png" alt="Parent Image" class="parent-img">
                <button class="select-parent" onclick="buildParentSelection('${parentName}', '${key}'); event.stopPropagation();">
                    ${parentName}
                </button>
            </div>
            <div class="option-name">${parentName}</div>
            ${icon}
        </div>`;
    }
...
const buildParentSelection = (title, key) => {
    ...
    <div class="pages-container">
        <div class="middle-creator heritage-grid">`;
    ...
    div += `
        <div class="option-select" onclick="showAllParents('${key}')">
...
const buildColorSelection = (title, el, key, makeup) =>{
    $(".section-selector").hide();
    let container = $(".container2");
    let div = `<div class="top-creator">
    </div>
    <div class="pages-container">
        <div class="middle-colors color-grid">`;
    if (key == "makeup-color") {
    ...
    for (let k in makeUpColors) {
        ...
        if (k == player[key]) {
            classe = "color-select color-selected";
            icon = "<div class='color-checked'><i class='fas fa-check'></i></div>";
        }
    ...
    div += `</div></div>
    <div class="confirm-button" onclick="confirmSelection()"><i class="fas fa-check"></i></div>
    <div class="opacity-slider ${opacityKey}">
           ...
           <input type="range" value="${Math.floor(player[opacityKey]*100)}" min="0" max="100" oninput="changeSliderColor(this, '${opacityKey}')">
            <span class="slider-value">${Math.floor(player[opacityKey] * 100)}</span>
        </div>`;
    container.slideUp(500,()=>{
        container.html(div).slideDown(500);
...
const buildShapeSelection = (title, el, key) =>{
    ...
    <div class="pages-container">
        <div class="middle-creator option-grid">`
    ;
    ...
    div += `</div></div> <div class="confirm-button" onclick="confirmSelection()"><i class="fas fa-check"></i></div>`;
...
const changeSliderColor = (el, key) =>{
    const sliderContainer = $(el).closest(".opacity-slider");
    const sliderValue = sliderContainer.find(".slider-value");

    sliderValue.text(el.value);

    const sliderWidth = el.offsetWidth;
    const thumbOffset = (el.value / el.max) * sliderWidth;
    sliderValue.css("left", `${thumbOffset}px`); 

    $(el).css({
        "border-radius": "0.8781558726673985vh"
    });
...
const buildChars = () => {
    let inner = "";
    const totalSlots = charInfos.chars.length + 1; 
    //Remover o for da linha 1180 e descomentar o da 1179 para voltar para logica original
    // for (let i = 0; i < charInfos.maxChars; i++) {
    for (let i = 0; i < totalSlots; i++) {
        let charName = lang.empty;
        let charId = `<i class="empty-icon fas fa-plus"></i>`;
        let emptyClass = "empty-char";

        if (charInfos.chars[i]) {
            let info = charInfos.chars[i];
            charName = `<img class="char-icon" src="src/icons/user.svg" alt="User Icon"> ${info.name}`;
            charId = `<div class="char-id-container"><img class="char-id-icon" src="src/icons/id.svg" alt="ID Icon">${info.id}</div>`;
            emptyClass = "";
        } else {
            charName = lang.empty;
        }

        let div = `<div class="char-selector ${emptyClass}" onclick="selectChar(${i}, this)">
            ${charId}
