...
-- Mapeamento direto da vRP usada nesta cidade.
-- A chave é o job usado pelo LB Phone e os valores são grupos/permissões reais da vRP.
Config.VRPJobs = {
    police = { "LSPD", "PRPD", "Police" },
    ambulance = { "Paramedic" },
    mechanic = { "Mechanic" },
    restaurant = { "BurgerShot" }
}

Config.VRPAdminGroups = { "Admin" }
...
Config.CellTowers.MinService = 0 -- Seoul: sinal mais realista; pode ficar sem serviço em áreas afastadas
Config.CellTowers.Range = {
    [4] = 90.0, -- Seoul: 4 barras apenas muito perto da torre
    [3] = 220.0,
    [2] = 450.0,
    [1] = 900.0,
}
...
Config.Locations = { -- Locations that'll appear in the maps app.
    -- {
    --     position = vector2(383.45, -1590.27),
    --     name = "BHPD",
    --     description = "BHPD",
    --     icon = "https://assets.beverlyhillsrp.com.br/assets/icon_police.png",
    -- },
}
...
Config.PhoneNumber.Length = 3 -- This is the length of the phone number WITHOUT the prefix.
...
Config.Battery.ChargeInterval = { 3, 4 } -- How much battery
Config.Battery.DischargeInterval = { 30, 40 } -- How many seconds for each percent to be removed from the battery
...
-- Seoul Charging Stations
-- Pontos físicos onde o jogador chega perto e aperta E para carregar o celular devagar.
-- Para adicionar outro ponto, copie uma linha de Stations e troque as coordenadas.
Config.SeoulCharging = {
    Enabled = true,
    Key = 38, -- E
    Distance = 2.0,
    MarkerDistance = 12.0,
    ChargeEverySeconds = 10, -- velocidade do carregamento
    ChargeAmount = 1, -- porcentagem adicionada a cada ciclo
    DrawMarker = true,
    Notify = true,
    Stations = {
        { coords = vector3(25.73, -1347.27, 29.50), label = "Carregador 24/7 - Strawberry" },
        { coords = vector3(-47.29, -1757.70, 29.42), label = "Carregador LTD - Davis" },
        { coords = vector3(-707.41, -914.57, 19.22), label = "Carregador LTD - Little Seoul" },
        { coords = vector3(1163.53, -323.66, 69.21), label = "Carregador LTD - Mirror Park" },
        { coords = vector3(373.88, 326.36, 103.57), label = "Carregador 24/7 - Downtown Vinewood" },
        { coords = vector3(2557.45, 382.20, 108.62), label = "Carregador 24/7 - Palomino" },
        { coords = vector3(-3039.02, 584.39, 7.91), label = "Carregador 24/7 - Banham Canyon" },
        { coords = vector3(-3242.47, 1001.14, 12.83), label = "Carregador 24/7 - Chumash" },
        { coords = vector3(1961.46, 3740.67, 32.34), label = "Carregador 24/7 - Sandy Shores" },
        { coords = vector3(1729.15, 6414.92, 35.04), label = "Carregador 24/7 - Paleto" },
    }
}
...
Config.CityName = "Seoul" -- The name that's being used in the weather app etc.
...
Config.GroupMessageMemberLimit = 80 -- maximum amount of members in a group message
...
Config.AutoFollow.InstaPic.Accounts = { "gossipgirl" } -- array of usernames to automatically follow when creating an account. e.g. "username", "anotherusername"
