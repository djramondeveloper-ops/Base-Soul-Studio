...
if Config.WordBlacklist and Config.WordBlacklist.Enabled then
...
function ContainsBlacklistedWord(source, app, text)
    if not (Config.WordBlacklist and Config.WordBlacklist.Enabled) or not Config.WordBlacklist.Apps[app] or type(text) ~= "string" then
        return false
    end
