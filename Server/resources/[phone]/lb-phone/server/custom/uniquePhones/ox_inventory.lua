...
function HasPhoneNumber(source, phoneNumber)
    ...
    for i = 1, #phones do
        if phones[i] and phones[i].metadata and phones[i].metadata.lbPhoneNumber == phoneNumber then
            debugprint("they do")
            return true
        end
    end
...
function SetPhoneNumber(source, phoneNumber)
    ...
    for i = 1, #phones do
        ...
        if not (phone and phone.metadata and phone.metadata.lbPhoneNumber) then
            phone.metadata = {
