...
function GetFirstNumber()
    ...
    for i = 1, #phones do
        ...
        if phone and phone.info and phone.info.lbPhoneNumber then
...
function HasPhoneNumber(number)
    ...
    for i = 1, #phones do
        ...
        if phone and phone.info and phone.info.lbPhoneNumber == number then
            return true
        end
    end
...
RegisterNetEvent("lb-phone:usePhoneItem", function(data)
    local number = data and data.info and data.info.lbPhoneNumber
