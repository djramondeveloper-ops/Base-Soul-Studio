...
function SetPhoneVariation(variation)
    ...
    if itemData.frameColor then
        if not (settings and settings.display and settings.display.frameColor == itemData.frameColor) then
            oldFrameColor = settings and settings.display and settings.display.frameColor
        end
