...
---@return string
function GetJob()
    return ESX.PlayerData and ESX.PlayerData.job and ESX.PlayerData.job.name or "unemployed"
end

---@return number
function GetJobGrade()
    return ESX.PlayerData and ESX.PlayerData.job and ESX.PlayerData.job.grade or 0
end
