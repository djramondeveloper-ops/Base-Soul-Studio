...
local List = {
	...
	["themeparkpass"] = {
    ["Index"] = "themeparkpass",
    ["Name"] = "Passe do Parque",
    ["Description"] = "Passe temporário para acesso às atrações do parque.",
    ["Type"] = "Consumível",
    ["Weight"] = 0.05,
    ["Economy"] = 0
	},
...
Puritys = {
	{ Percent = 0, Chance = 25 },
	{ Percent = 10, Chance = 20 },
	{ Percent = 20, Chance = 15 },
	{ Percent = 30, Chance = 12 },
	{ Percent = 40, Chance = 10 },
	{ Percent = 50, Chance = 8 },
	{ Percent = 60, Chance = 5 },
	{ Percent = 70, Chance = 3 },
	{ Percent = 80, Chance = 1.5 },
	{ Percent = 90, Chance = 0.4 },
	{ Percent = 100, Chance = 0.1 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- CLONEVARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
