...
-- RELOADCHARACTER
-----------------------------------------------------------------------------------------------------------------------------------------
local function SeoulSafeApply(resource, exportName, eventName, ...)
...
function tvRP.ReloadCharacter()
	SeoulSafeApply("skinshop","Apply","skinshop:Apply")
	SeoulSafeApply("nation_skinshop","Apply","skinshop:Apply")

	SeoulSafeApply("barbershop","Apply","barbershop:Apply")
	SeoulSafeApply("nation_barbershop","Apply","barbershop:Apply")

	SeoulSafeApply("tattooshop","Apply","tattooshop:Apply")
	SeoulSafeApply("nation_tattoos","Apply","tattooshop:Apply")
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- VRP:ACTIVE
-----------------------------------------------------------------------------------------------------------------------------------------
